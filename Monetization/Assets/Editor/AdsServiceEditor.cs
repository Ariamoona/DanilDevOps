...
public class AdsServiceEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            EditorGUILayout.HelpBox(" Запустите сцену для тестирования рекламы", MessageType.Info);
            return;
        }
        ...
        {
            EditorGUILayout.HelpBox(" Введите ваш Android Game ID из Unity Dashboard!", MessageType.Warning);
        }
    }
}
